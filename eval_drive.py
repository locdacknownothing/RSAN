...
from RSAN import *
model=RSANet(input_size=(desired_size,desired_size,3),start_neurons=16,keep_prob=1,lr=1e-3)
weight="Drive/Model/RSAN_soft_dice_cldice.h5"
...
saved_image_dir = 'Drive/test/result_soft_dice_cldice'
